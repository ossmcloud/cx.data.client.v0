...
// TABLE NAME
//
const _tableName = 'epos_shop_configs';
//
...
const _fields = {
    ...
    configValue: { name: 'configValue', dataType: 'varchar', pk: false, identity: false, maxLength: 4000, null: false },
...
//
class Persistent_epos_shop_configs_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_epos_shop_configs extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_epos_shop_configs_Collection,
    Record: Persistent_epos_shop_configs,
}