...
// TABLE NAME
//
const _tableName = 'ca_settingShop';
//
...
//
class Persistent_ca_settingShop_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_ca_settingShop extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_ca_settingShop_Collection,
    Record: Persistent_ca_settingShop,
}