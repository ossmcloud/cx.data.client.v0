...
// TABLE NAME
//
const _tableName = 'erp_shop_configs';
//
...
//
class Persistent_erp_shop_configs_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_erp_shop_configs extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_erp_shop_configs_Collection,
    Record: Persistent_erp_shop_configs,
}