...
// TABLE NAME
//
const _tableName = 'cs_erp_transaction_tax';
//
...
//
class Persistent_cs_erp_transaction_tax_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cs_erp_transaction_tax extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cs_erp_transaction_tax_Collection,
    Record: Persistent_cs_erp_transaction_tax,
}