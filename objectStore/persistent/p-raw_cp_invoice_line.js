...
// TABLE NAME
//
const _tableName = 'raw_cp_invoice_line';
//
...
//
const _fields = {
    rawInvoiceLineId: { name: 'rawInvoiceLineId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
...
//
class Persistent_raw_cp_invoice_line_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_raw_cp_invoice_line extends _cx_data.DBRecord {
    ...
    get rawInvoiceLineId() {
        return super.getValue(_fieldNames.RAWINVOICELINEID);
    }
...
//
module.exports = {
    Table: Persistent_raw_cp_invoice_line_Collection,
    Record: Persistent_raw_cp_invoice_line,
}