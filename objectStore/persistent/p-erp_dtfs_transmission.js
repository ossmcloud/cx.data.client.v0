...
// TABLE NAME
//
const _tableName = 'erp_dtfs_transmission';
//
...
//
class Persistent_erp_dtfs_transmission_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_erp_dtfs_transmission extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_erp_dtfs_transmission_Collection,
    Record: Persistent_erp_dtfs_transmission,
}