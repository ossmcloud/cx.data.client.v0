...
// TABLE NAME
//
const _tableName = 'cr_preference';
//
...
//
class Persistent_cr_preference_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cr_preference extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cr_preference_Collection,
    Record: Persistent_cr_preference,
}