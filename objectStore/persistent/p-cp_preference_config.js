...
// TABLE NAME
//
const _tableName = 'cp_preference_config';
//
...
//
class Persistent_cp_preference_config_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_preference_config extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cp_preference_config_Collection,
    Record: Persistent_cp_preference_config,
}