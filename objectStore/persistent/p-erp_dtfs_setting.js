...
// TABLE NAME
//
const _tableName = 'erp_dtfs_setting';
//
...
//
class Persistent_erp_dtfs_setting_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_erp_dtfs_setting extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_erp_dtfs_setting_Collection,
    Record: Persistent_erp_dtfs_setting,
}