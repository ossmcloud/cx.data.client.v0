...
// TABLE NAME
//
const _tableName = 'cr_preference_value';
//
...
//
class Persistent_cr_preference_value_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cr_preference_value extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cr_preference_value_Collection,
    Record: Persistent_cr_preference_value,
}