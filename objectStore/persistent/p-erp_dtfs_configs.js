...
// TABLE NAME
//
const _tableName = 'erp_dtfs_configs';
//
...
//
class Persistent_erp_dtfs_configs_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_erp_dtfs_configs extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_erp_dtfs_configs_Collection,
    Record: Persistent_erp_dtfs_configs,
}