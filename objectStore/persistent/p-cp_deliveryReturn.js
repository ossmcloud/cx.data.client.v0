...
// TABLE NAME
//
const _tableName = 'cp_deliveryReturn';
//
...
//
class Persistent_cp_deliveryReturn_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_deliveryReturn extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cp_deliveryReturn_Collection,
    Record: Persistent_cp_deliveryReturn,
}