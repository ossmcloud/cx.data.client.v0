...
// TABLE NAME
//
const _tableName = 'cs_erp_transaction';
//
...
const _fields = {
    ...
    isReverse: { name: 'isReverse', dataType: 'bit', pk: false, identity: false, maxLength: 1, null: true },

}
//
// PERSISTENT TABLE OBJECT (THIS REPRESENTS A COLLECTION OF RECORDS)
//
class Persistent_cs_erp_transaction_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cs_erp_transaction extends _cx_data.DBRecord {
    ...
    get isReverse() {
        return super.getValue(_fieldNames.ISREVERSE);
    } set isReverse(val) {
        super.setValue(_fieldNames.ISREVERSE, val);
    }
...
//
module.exports = {
    Table: Persistent_cs_erp_transaction_Collection,
    Record: Persistent_cs_erp_transaction,
}