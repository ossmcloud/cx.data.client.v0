...
// TABLE NAME
//
const _tableName = 'ca_settingApproverShop';
//
...
//
class Persistent_ca_settingApproverShop_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_ca_settingApproverShop extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_ca_settingApproverShop_Collection,
    Record: Persistent_ca_settingApproverShop,
}