...
// TABLE NAME
//
const _tableName = 'erp_traderAccount';
//
...
//
class Persistent_erp_traderAccount_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_erp_traderAccount extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_erp_traderAccount_Collection,
    Record: Persistent_erp_traderAccount,
}