...
// TABLE NAME
//
const _tableName = 'cs_stockValuationLog';
//
...
//
const _fields = {
    stockValuationLogId: { name: 'stockValuationLogId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
...
//
class Persistent_cs_stockValuationLog_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cs_stockValuationLog extends _cx_data.DBRecord {
    ...
    get stockValuationLogId() {
        return super.getValue(_fieldNames.STOCKVALUATIONLOGID);
    }
...
//
module.exports = {
    Table: Persistent_cs_stockValuationLog_Collection,
    Record: Persistent_cs_stockValuationLog,
}