...
// TABLE NAME
//
const _tableName = 'cp_invoiceCreditLog';
//
...
//
const _fields = {
    invCreLogId: { name: 'invCreLogId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
...
//
class Persistent_cp_invoiceCreditLog_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_invoiceCreditLog extends _cx_data.DBRecord {
    ...
    get invCreLogId() {
        return super.getValue(_fieldNames.INVCRELOGID);
    }
...
//
module.exports = {
    Table: Persistent_cp_invoiceCreditLog_Collection,
    Record: Persistent_cp_invoiceCreditLog,
}