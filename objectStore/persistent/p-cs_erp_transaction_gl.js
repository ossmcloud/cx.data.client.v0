...
// TABLE NAME
//
const _tableName = 'cs_erp_transaction_gl';
//
...
//
class Persistent_cs_erp_transaction_gl_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cs_erp_transaction_gl extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cs_erp_transaction_gl_Collection,
    Record: Persistent_cs_erp_transaction_gl,
}