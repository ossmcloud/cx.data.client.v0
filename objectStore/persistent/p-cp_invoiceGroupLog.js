...
// TABLE NAME
//
const _tableName = 'cp_invoiceGroupLog';
//
...
//
const _fields = {
    invGrpLogId: { name: 'invGrpLogId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
    invGrpId: { name: 'invGrpId', dataType: 'bigint', pk: false, identity: false, maxLength: 8, null: false },
...
//
class Persistent_cp_invoiceGroupLog_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_invoiceGroupLog extends _cx_data.DBRecord {
    ...
    get invGrpLogId() {
        return super.getValue(_fieldNames.INVGRPLOGID);
    }
...
//
module.exports = {
    Table: Persistent_cp_invoiceGroupLog_Collection,
    Record: Persistent_cp_invoiceGroupLog,
}