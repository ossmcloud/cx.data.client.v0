...
// TABLE NAME
//
const _tableName = 'cp_preference_record';
//
...
//
class Persistent_cp_preference_record_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_preference_record extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cp_preference_record_Collection,
    Record: Persistent_cp_preference_record,
}