...
// TABLE NAME
//
const _tableName = 'cp_wholesalerConfig';
//
...
//
class Persistent_cp_wholesalerConfig_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_wholesalerConfig extends _cx_data.DBRecord {
...
//
module.exports = {
    Table: Persistent_cp_wholesalerConfig_Collection,
    Record: Persistent_cp_wholesalerConfig,
}