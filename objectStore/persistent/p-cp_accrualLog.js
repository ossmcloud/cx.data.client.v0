...
// TABLE NAME
//
const _tableName = 'cp_accrualLog';
//
...
//
const _fields = {
    accrLogId: { name: 'accrLogId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
...
//
class Persistent_cp_accrualLog_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_cp_accrualLog extends _cx_data.DBRecord {
    ...
    get accrLogId() {
        return super.getValue(_fieldNames.ACCRLOGID);
    }
...
//
module.exports = {
    Table: Persistent_cp_accrualLog_Collection,
    Record: Persistent_cp_accrualLog,
}