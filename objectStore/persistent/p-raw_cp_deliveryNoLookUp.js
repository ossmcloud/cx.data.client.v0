...
// TABLE NAME
//
const _tableName = 'raw_cp_deliveryNoLookUp';
//
...
//
const _fields = {
    rawDeliveryNoLookUpId: { name: 'rawDeliveryNoLookUpId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
...
//
class Persistent_raw_cp_deliveryNoLookUp_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_raw_cp_deliveryNoLookUp extends _cx_data.DBRecord {
    ...
    get rawDeliveryNoLookUpId() {
        return super.getValue(_fieldNames.RAWDELIVERYNOLOOKUPID);
    }
...
//
module.exports = {
    Table: Persistent_raw_cp_deliveryNoLookUp_Collection,
    Record: Persistent_raw_cp_deliveryNoLookUp,
}