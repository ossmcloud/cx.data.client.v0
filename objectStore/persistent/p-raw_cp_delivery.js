...
// TABLE NAME
//
const _tableName = 'raw_cp_delivery';
//
...
//
const _fields = {
    rawDeliveryId: { name: 'rawDeliveryId', dataType: 'bigint', pk: true, identity: true, maxLength: 8, null: false },
...
//
class Persistent_raw_cp_delivery_Collection extends _cx_data.DBTable {
    constructor() {
...
//
class Persistent_raw_cp_delivery extends _cx_data.DBRecord {
    ...
    get rawDeliveryId() {
        return super.getValue(_fieldNames.RAWDELIVERYID);
    }
...
//
module.exports = {
    Table: Persistent_raw_cp_delivery_Collection,
    Record: Persistent_raw_cp_delivery,
}