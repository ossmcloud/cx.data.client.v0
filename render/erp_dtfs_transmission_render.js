...
class ErpTransmissionRender extends RenderBase {
    ...
    async _record() {
        ...
        if (this.dataSource.status == _cxConst.EPOS_DTFS_TRANSMISSION.STATUS.TRANSMITTING || this.dataSource.status == _cxConst.EPOS_DTFS_TRANSMISSION.STATUS.PENDING) {
            this.options.buttons.push({ id: 'erp_dtfs_transmission_abort', text: 'Abort Transmission', function: 'abort' });
        }
    }
...
module.exports = ErpTransmissionRender;