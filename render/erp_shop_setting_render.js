                ...
                group: 'settingOuter', title: '', columnCount: 2, fields: [
                    {
                        group: 'main', title: 'main info', column: 1, columnCount: 2, fields: [
                            ...
                            { name: 'erpCompanyName', label: 'erp company name', column: 1, readOnly: false },
                            { name: 'erpCustomerAccount', label: 'erp EPoS account code', column: 2, readOnly: false },
                            { name: 'erpCustomerAccountName', label: 'erp EPoS Account name', column: 1, readOnly: false },
                            { name: 'erpCostCentre', label: 'force gl segment 2', column: 2, readOnly: false },
                            { name: 'erpDepartment', label: 'force gl segment 3', column: 1, readOnly: false },
                            { name: 'dtfsSettingId', label: 'ERPS Settings', column: 2, readOnly: false },
