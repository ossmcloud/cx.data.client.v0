...
class WholesalerShopConfig extends RenderBase {
    ...
    async _record() {
        ...
        if (this.options.dialog) {
            ...
            this.options.fields[0].fields.push({ name: _cxSchema.cp_wholesalerShopConfig.WHOLESALERID, hidden: true });
            this.options.fields[0].fields.push({ name: _cxSchema.cp_wholesalerShopConfig.SHOPID, hidden: true });
        } else {
    ...
    async _list() {
        ...
        this.options.columns = [
            { name: _cxSchema.cp_wholesalerShopConfig.CONFIGID, title: 'id', align: 'left' },
            { name: _cxSchema.cp_wholesalerShopConfig.CONFIGNAME, title: 'name', align: 'left' },
            { name: _cxSchema.cp_wholesalerShopConfig.CONFIGVALUE + 'Display', title: 'value', align: 'left' },
        ];
    }

}

module.exports = WholesalerShopConfig;